...
int main(int argc, const char **argv)
{
  ...
  info.client_ssl_cert_filepath = "../backend/ca/intermediate/certs/sensor2.cert.pem";
  info.client_ssl_private_key_filepath ="../backend/ca/intermediate/private/sensor2.key";
