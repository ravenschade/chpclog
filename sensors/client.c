...
int main(int argc, const char **argv)
{
  ...
  info.client_ssl_ca_filepath = "../backend/ca/intermediate/certs/ca-chain.cert.pem";
  info.client_ssl_cert_filepath = "../backend/ca/intermediate/certs/sensor1.cert.pem";
  info.client_ssl_private_key_filepath ="../backend/ca/intermediate/private/sensor1.key.pem";
